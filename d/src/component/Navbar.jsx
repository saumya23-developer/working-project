...
import vectorImage from '../assest/Vector.png';
    ...
    <div className="site-nav">
      <div className="nav-top">
        <div className="left-element">
          <div className="Frame">
            <h1 className="logo">Chatterly</h1>
            <div className="img">
        ...
        <div className="right-element">
          ...
          <span id="name-box">Sahil Sharma</span>
          <div>
      ...
      <nav>
        <div className="filters-section">
          <div className="nav2-rightelement">
            <h2>Filters</h2>
              ...
              <div id="createdby1">
                ...
                <div>
                  <select id="createdby" name="createdby" required>
                    ...
                    <option value="saa">Saumya</option>
                    <option value="sab">Saumya</option>
                    <option value="sac">Saumya</option>
                    <option value="sad">Saumya</option>
                  </select>
                </div>
              </div>
              <div>
                ...
                <div>
                  <input type="date" id="published" name="published" placeholder="Select Date" />
                </div>
              </div>
            </div>
            <div>
              <form>
                <label htmlFor="fsrch">Search</label>
                <input type="text" id="fsrch" name="search" placeholder="Type here" />
                <svg
                  version="1.1"
                  id="Layer_1"
